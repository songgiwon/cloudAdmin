...
<script>
	...
	$(document).ready( function() {
		...
		var tb2=$("#tableList").DataTable({
			ajax : {
                "url":"/admin/support/faq/faqList.ajax",
                "type":"POST",
                "dataType": "json",
            },  
            columns: [
	...
	function search(){
		 ...
		 if(listArr.length==0){
			 ...
			 frm+="&listArr="+listArr;
			 var tagUrl="/admin/support/faq/faqList.ajax";
...
<body class="open">
    ...
    <div id="container" class="container-wrap">
		...
		<div id="contents" class="contents-wrap list_ani">
			...
			<div class="btn_box">
				<div class="right">
					<button class="btn btn_primary" id="btnDownload" onclick="location.href='/admin/support/faq/excelDownload.ajax'">
			...
			<div id="footer" class="footer-wrap">
		        <div id="footer-inner" class="footer-inner">
		            ...
		            <div class="btn_box">
		                <div class="right">
		                    <button class="btn btn_primary" style="" id="btnInsert" onclick="location.href='/admin/support/faq/faqInsert.do'"><span class="langSpan">등록</span></button>
